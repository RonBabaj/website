        ...
        child: Column(children: [
          ...
          Container(
            ...
            child: Column(children: [
              ...
              Text(
                ...
                textAlign: TextAlign.center,
                style: TextStyle(
                    color: Colors.white70, fontFamily: 'Bodoni', fontSize: 80),
              ),
              ...
              Text(
                ...
                textAlign: TextAlign.center,
                style: TextStyle(
                    color: Colors.white70, fontFamily: 'Rubik', fontSize: 25),
              ),
              Text(
          ...
          Container(
              ...
              child: Column(
                children: [
                  ...
                  Padding(padding: EdgeInsets.only(top: 60)),
                  Text(
                    "* More Detailed Information Is Available On My LinkedIn\n(You Can Find My LinkedIn Under 'Contact')",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                        color: Colors.black54,
                        fontFamily: 'Rubik',
          ...
          Container(
            ...
            child: Column(children: [
              ...
              Padding(
                padding: EdgeInsets.fromLTRB(150, 80, 170, 0),
                child: Text(
